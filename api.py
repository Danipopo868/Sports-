...
class ApiSportsError(RuntimeError):
    """Error del proveedor; nunca se sustituye con datos inventados."""
...
class ApiSportsClient:
    ...
    def __init__(
        ...
        self._batch_odds_supported: dict[
            str,
            bool,
        ] = {}
    ...
    def _get(
        ...
        # ----------------------------------------------------
        # 3 INTENTOS SI HAY ERROR TEMPORAL
        # ----------------------------------------------------
        ...
        # ----------------------------------------------------
        # ERRORES DEVUELTOS POR API-SPORTS
        # ----------------------------------------------------
    ...
    def odds_for_date(
        ...
        """
        Primero intenta leer las cuotas
        de todos los partidos por fecha.

        Si ese endpoint no funciona para
        ese deporte, consulta partido por
        partido.

        Usa caché para no gastar
        solicitudes innecesariamente.
        """
